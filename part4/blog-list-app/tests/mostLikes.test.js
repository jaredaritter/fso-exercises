...
describe('Most Likes', () => {
  ...
  test('A list with a single entry returns the author of the entry and the number of likes of that entry', () => {
    const blogs = [
      {
  ...
  test('A list with multiple entries returns the author with the largest total number of likes and that number', () => {
    const blogs = [
      {
        _id: '5a422aa71b54a676234d17f8',
        title: 'Go To Statement Considered Harmful',
      ...
      {
        _id: '5a422aa71b54a676234d17f8',
        title: 'Debts To Be Paid 2: Raising the Debt Ceiling',
        author: 'Jamie Lannister',
        url: 'http://www.u.arizona.edu/~rubinson/copyright_violations/Debts_To_Be_Paid_2.html',
        likes: 17,
        __v: 0,
      },
    ];
